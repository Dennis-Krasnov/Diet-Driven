...
extension ScrollControllerExtensions on ScrollController {
  /// ...
  Future<void> delayedAnimateTo(double offset) async {
    // Execute after [NotificationListener] processes [ScrollNotification]
    await Future<void>.delayed(10.milliseconds);
    // ... TODO: vary duration based on delta (constant factor) this.offset vs offset!
    animateTo(offset, duration: 200.milliseconds, curve: Curves.ease);
  }
