...
//
/////
//void pushIfNecessary(BuildContext context, {@required String path, bool animate = false}) {
//  if (!ModalRoute.of(context).settings.name.startsWith(path)) {
//      Navigator.of(context).pushNamed(path, arguments: animate ? TransitionType.native : TransitionType.none);
//  }
//}
//
...
//          BlocLogger().fine("Processing settings deep link: $settingsDL");
//
...
//            BlocLogger().fine("Processing diary settings deep link: $diarySettingsDL");
//
...
//            }
//
//            if (deepLinkIterator.current is DiaryCyclingSettingsDeepLink) {
//              final diaryCyclingSettingsDL = deepLinkIterator.current as DiaryCyclingSettingsDeepLink;
//              BlocLogger().fine("Processing diary calorie cycling deep link: $diaryCyclingSettingsDL");
//
//              pushIfNecessary(context, path: "settings/diary/cycling", animate: routeState.shouldAnimate);
//            }
//          }
...
//            BlocLogger().fine("Processing theme settings deep link: $themeSettingsDL");
//
