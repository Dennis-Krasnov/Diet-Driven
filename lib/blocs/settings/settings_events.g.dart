...
class _$LoadInitialSettings extends LoadInitialSettings {
  @override
  final String userId;

  factory _$LoadInitialSettings([void updates(LoadInitialSettingsBuilder b)]) =>
      (new LoadInitialSettingsBuilder()..update(updates)).build();

  _$LoadInitialSettings._({this.userId}) : super._() {
    if (userId == null) {
      throw new BuiltValueNullFieldError('LoadInitialSettings', 'userId');
    }
  }

  @override
  LoadInitialSettings rebuild(void updates(LoadInitialSettingsBuilder b)) =>
      (toBuilder()..update(updates)).build();

  @override
  LoadInitialSettingsBuilder toBuilder() =>
      new LoadInitialSettingsBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is LoadInitialSettings && userId == other.userId;
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('LoadInitialSettings')
          ..add('userId', userId))
        .toString();
  }
}

class LoadInitialSettingsBuilder
    implements Builder<LoadInitialSettings, LoadInitialSettingsBuilder> {
  _$LoadInitialSettings _$v;

  String _userId;
  String get userId => _$this._userId;
  set userId(String userId) => _$this._userId = userId;

  LoadInitialSettingsBuilder();

  LoadInitialSettingsBuilder get _$this {
    if (_$v != null) {
      _userId = _$v.userId;
      _$v = null;
    }
  ...
  @override
  void replace(LoadInitialSettings other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$LoadInitialSettings;
  }

  @override
  void update(void updates(LoadInitialSettingsBuilder b)) {
    if (updates != null) updates(this);
  }

  @override
  _$LoadInitialSettings build() {
    final _$result = _$v ?? new _$LoadInitialSettings._(userId: userId);
    replace(_$result);
    return _$result;
  }
}
