...
abstract class UpdateQuery with FoodSearchEvent implements Built<UpdateQuery, UpdateQueryBuilder> {
  ...
  UpdateQuery._();
  factory UpdateQuery([updates(UpdateQueryBuilder b)]) = _$UpdateQuery;
}
...
//
//  FoodSearchError._();
//  factory FoodSearchError([updates(FoodSearchErrorBuilder b)]) = _$FoodSearchError;
//}
...
abstract class SearchFoods with FoodSearchEvent implements Built<SearchFoods, SearchFoodsBuilder> {
  ...
  SearchFoods._();
  factory SearchFoods([updates(SearchFoodsBuilder b)]) = _$SearchFoods;
}
